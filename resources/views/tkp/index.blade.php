<!-- resources/views/tkp/index.blade.php -->
@extends('layouts.app')
...
@section('content')
    ...
    <a href="{{ route('tkp.create') }}" class="btn btn-primary mb-3">Tambah Tabel Klasifikasi Pelanggan</a>
            ...
            <tbody>
                @foreach ($tkp as $tkp)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('tkp.edit', $tkp->id) }}" class="btn btn-primary">Edit</a>
