        ...
        <tbody>
            @foreach ($dsb as $data)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('dsb.show', $data->id) }}" class="btn btn-primary">Lihat</a>
                        <a href="{{ route('dsb.edit', $data->id) }}" class="btn btn-success">Edit</a>
                        <form action="{{ route('dsb.destroy', $data->id) }}" method="POST" class="d-inline">
                            @csrf
                            @method('DELETE')
