<!-- resources/views/gi/index.blade.php -->
@extends('layouts.app')
...
@section('content')
    ...
    <a href="{{ route('gi.create') }}" class="btn btn-primary mb-3">Tambah Galeri IPA</a>
            ...
            <tbody>
                @foreach ($gi as $gi)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('gi.edit', $gi->id) }}" class="btn btn-primary">Edit</a>
