...
@section('admin-content')
    ...
    <a href="{{ route('admin.ipam.create') }}" class="btn btn-primary mb-3">Tambah Instalasi Pengolahaan Air Minum</a>
            ...
            <tbody>
                @foreach ($ipam as $ipam)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.ipam.edit', $ipam->id) }}" class="btn btn-primary">Edit</a>
                            <form action="{{ route('admin.ipam.destroy', $ipam->id) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
