...
@section('admin-content')
    ...
    <a href="{{ route('admin.sab.create') }}" class="btn btn-primary mb-3">Tambah Tabel Klasifikasi Pelanggan</a>
            ...
            <tbody>
                @foreach ($sab as $sab)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.sab.edit', $sab->id) }}" class="btn btn-primary">Edit</a>
