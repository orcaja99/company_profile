...
@section('admin-content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <p class="card-text">{{ $jpegawai->nama }}</p>
        </div>
    </div>
    ...
    <a href="{{ route('admin.jpegawai.edit', $pegawai->id) }}" class="btn btn-primary mt-3">Edit</a>
    <form action="{{ route('admin.jpegawai.destroy', $pegawai->id) }}" method="POST" class="d-inline">
        @csrf
        @method('DELETE')
