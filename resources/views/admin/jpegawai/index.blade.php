...
@section('admin-content')
    ...
    <a href="{{ route('admin.jpegawai.create') }}" class="btn btn-primary mb-3">Tambah Jumlah Pegawai</a>
            ...
            <tbody>
                @foreach ($jpegawai as $jpegawai)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.jpegawai.edit', $jpegawai->id) }}" class="btn btn-primary">Edit</a>
