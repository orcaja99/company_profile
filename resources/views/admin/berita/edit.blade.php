...
@section('admin-content')
    ...
    <body>
        <div class="container mt-4">
            ...
            <textarea class="form-control tiny-mce" name="judul" id="judul" rows="5" style="height: 200px;">{{ $berita->judul }}</textarea>
            @error('judul')
            ...
            <textarea class="form-control tiny-mce" name="keterangan" id="keterangan" rows="5" style="height: 200px;">{{ $berita->keterangan }}</textarea>
            @error('keterangan')
                <div class="text-danger">{{ $message }}</div>
            @enderror
        </div>
